  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 p-4 flex flex-col md:hidden"
          >
      ...
      <motion.div
        ...
        className="hidden md:flex bg-white border-r border-gray-200 p-4 flex-col"
      >
        <div className="flex items-center justify-between mb-8">
          {isDesktopSidebarOpen && <h1 className="font-bold text-xl text-gray-800">DormControl</h1>}
          <button
